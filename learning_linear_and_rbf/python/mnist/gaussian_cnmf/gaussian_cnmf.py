...
data, labels = dataset_factory.dataset_factory('../../../../dataset/mnist_2k.mat',
                                               options={'data': 'train_data_2000', 'labels': 'labels_train_data_2000'})
...
vector = generate_logarithm_vector_kernel(data, vect_to_prove, percentage=0.4)
