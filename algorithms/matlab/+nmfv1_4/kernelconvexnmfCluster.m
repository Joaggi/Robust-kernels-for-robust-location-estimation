function [indCluster,Xout,Aout,Yout,numIter,tElapsed,finalResidual]=kernelconvexnmfCluster(X,k,option)
...
if callNMF
   [Ak,A,Y,numIter,tElapsed,finalResidual]=kernelconvexnmf(X,k,option); 
end
