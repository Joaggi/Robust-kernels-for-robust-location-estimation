function [indCluster,Xout,Aout,Yout,numIter,tElapsed,finalResidual]=kernelseminmfnnlsCluster(X,k,option)
...
if callNMF
   [A,Y,numIter,tElapsed,finalResidual]=kernelseminmfrule(X,k,option); 
end
