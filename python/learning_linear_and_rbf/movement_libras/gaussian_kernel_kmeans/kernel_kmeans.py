...
from semantic_methods_toolkit.python.unsupervised_technique.kernel_kmeans_experiment \
    import KernelKMeansExperiment
...
def gaussian_kernel_kmeans():
    ...
    data, labels = dataset_factory.dataset_factory('../../../../dataset/movement_libras.mat',
