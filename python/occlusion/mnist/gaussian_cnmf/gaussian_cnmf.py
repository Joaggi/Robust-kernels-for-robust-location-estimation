...
np.save(str(date) + 'gaussian_cnmf', {'last_results_performance': last_results_performance,
       'results_performance': results_performance, 'results_performance_tunning':
       results_performance_tunning,
